...
export async function GET(request: NextRequest) {
  try {
    ...
    // Calculate max for progress bars (cap at 150 for visual scaling, or best + 20)
    const maxScale = Math.max(100, bestWpm + 20);
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <span style={{ display: 'flex' }}>Best WPM</span>
                  </div>
                  <div
                    style={{
                      fontSize: '28px',
                ...
                >
                  <div
                    style={{
                      width: `${Math.min(100, (bestWpm / maxScale) * 100)}%`,
                      height: '100%',
              ...
              >
                ...
                >
                  ...
                  >
                    <span style={{ display: 'flex' }}>⚡</span>
                    <span style={{ display: 'flex' }}>Latest WPM</span>
                  </div>
                  <div
                    style={{
                      fontSize: '28px',
                ...
                >
                  <div
                    style={{
                      width: `${Math.min(100, (latestWpm / maxScale) * 100)}%`,
                      height: '100%',
              ...
              >
                ...
                >
                  ...
                  >
                    <span style={{ display: 'flex' }}>📊</span>
                    <span style={{ display: 'flex' }}>Average WPM</span>
                  </div>
                  <div
                    style={{
                      fontSize: '28px',
                ...
                >
                  <div
                    style={{
                      width: `${Math.min(100, (avgWpm / maxScale) * 100)}%`,
                      height: '100%',
