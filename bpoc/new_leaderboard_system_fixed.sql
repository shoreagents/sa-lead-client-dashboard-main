...
-- Focused on: Typing Hero, DISC Personality, Profile Completeness,
-- Resume Building, Work Status, and Job Applications
-- =====================================================

-- Drop old leaderboard tables (run this AFTER creating new system)
...
-- =====================================================
-- NEW LEADERBOARD TABLES
-- =====================================================

-- Single unified leaderboard scores table
CREATE TABLE IF NOT EXISTS public.user_leaderboard_scores (
...
-- Run this to populate scores for all existing users
...
COMMENT ON TABLE user_leaderboard_scores IS 'New unified leaderboard system - scores based on games, profile, resume, and applications';
