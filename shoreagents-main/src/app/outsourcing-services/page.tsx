        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <a href="/real-estate-outsourcing" className="inline-flex items-center text-lime-600 font-semibold hover:text-lime-700 transition-colors duration-200 text-sm">
                Learn More
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <a href="/property-management-outsourcing" className="inline-flex items-center text-lime-600 font-semibold hover:text-lime-700 transition-colors duration-200 text-sm">
                Learn More
                <ArrowRight className="w-4 h-4 ml-1" />
              </a>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <a href="/construction-outsourcing" className="inline-flex items-center text-lime-600 font-semibold hover:text-lime-700 transition-colors duration-200 text-sm">
                Learn More
                <ArrowRight className="w-4 h-4 ml-1" />
              </a>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <a href="/insurance-outsourcing" className="inline-flex items-center text-lime-600 font-semibold hover:text-lime-700 transition-colors duration-200 text-sm">
                Learn More
                <ArrowRight className="w-4 h-4 ml-1" />
              </a>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <a href="/mortgage-outsourcing" className="inline-flex items-center text-lime-600 font-semibold hover:text-lime-700 transition-colors duration-200 text-sm">
                Learn More
                <ArrowRight className="w-4 h-4 ml-1" />
              </a>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <a href="/legal-outsourcing" className="inline-flex items-center text-lime-600 font-semibold hover:text-lime-700 transition-colors duration-200 text-sm">
                Learn More
                <ArrowRight className="w-4 h-4 ml-1" />
              </a>
            </div>
